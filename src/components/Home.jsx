function Home() {
  ...
  return (
    <div className="">
      ...
      <p className="text-center text-xl mb-4">Click on the links above to see what I've been working on (it's clearthat graphic design is{tab}<del className="text-red-500 font-bold">not</del>{tab}my passion).</p>
      <img
